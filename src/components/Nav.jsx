    ...
    return (
      <div className=' bg-[#1E1E1E] pt-7 px-7 h-full md:h-full'>
            <div className='  flex  space-x-12 items-center'>
                <div className='flex'>
                    <div onClick={handleNav} className='ease-in-out duration-300 space-y-2 pt-3 pr-[25.77px] md:hidden '>
                        <svg width="18" height="2" viewBox="0 0 18 2" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M1 1H17" stroke="#EFEEE0" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                        <svg width="18" height="2" viewBox="0 0 18 2" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M1 1H17" stroke="#EFEEE0" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>                  
